...
def game_round(player, deck): #deck = the dictionary of cards, player = player object, 
    ...
    flag = True
    curr_hand = 0
    print("Dealer upcard = ", dealer_upcard.value)
    ...
    print("total money = ", player.bankroll)
...
def simulation(num_decks,num_players):
    ...
    tot_vals = []
    tot_rounds = []
    for i in range(1): #run 10,000 sets of ~500 hands (till runs out of money each time up to 1000)
        tot_vals = []
        John = Player("John",1000,100)
        num_games = 0
